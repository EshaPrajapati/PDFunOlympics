...
if (isset($_GET['id'])) {
    ...
    header("Location: /pd_esha/newspage.php");
    die();
}
        ...
        <div class="nav-bar" id="nav-bar">
          <nav>
            <ul>
              ...
              <li><a href="/pd_esha/aboutus.php">About</a></li>
              <li><a href="/pd_esha/contactus.php">Contact</a></li>
              <li><a href="/pd_esha/gallery.php">Gallery</a></li>
              <li><a href="/pd_esha/newspage.php">Latest News</a></li>
            </ul>
          </nav>
        </div>
